...
func SSHTunnels(data SSHTunnelsPageData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 3, "\" class=\"btn-ghost\"><i aria-hidden=\"true\" class=\"fas fa-terminal mr-2\"></i>Terminal</a> <a href=\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 4, "\" class=\"btn-ghost\"><i aria-hidden=\"true\" class=\"fas fa-folder mr-2\"></i>Files</a> <button @click=\"showNewTunnelModal = true\" class=\"btn-primary\"><i aria-hidden=\"true\" class=\"fas fa-plus mr-2\"></i>New Tunnel</button></div></div><!-- Connection Info Card --><div class=\"card p-4\"><div class=\"flex items-center justify-between\"><div class=\"flex items-center gap-4\"><div class=\"w-12 h-12 rounded-lg bg-dark-700 flex items-center justify-center\"><i aria-hidden=\"true\" class=\"fas fa-server text-xl text-primary-400\"></i></div><div><h3 class=\"text-white font-medium\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 6, "</p></div></div><div class=\"flex items-center gap-2\"><span class=\"flex items-center gap-2 text-sm text-green-400\"><span class=\"w-2 h-2 rounded-full bg-green-500 animate-pulse\"></span> Connected</span></div></div></div><!-- Tunnel Types Info --><div class=\"grid grid-cols-3 gap-4\"><div class=\"card p-4\"><div class=\"flex items-center gap-3 mb-2\"><div class=\"w-8 h-8 rounded bg-blue-500/20 flex items-center justify-center\"><i aria-hidden=\"true\" class=\"fas fa-arrow-right text-blue-400 text-sm\"></i></div><h4 class=\"text-white font-medium\">Local Forward</h4></div><p class=\"text-gray-400 text-xs\">Forward local port to remote destination through SSH</p></div><div class=\"card p-4\"><div class=\"flex items-center gap-3 mb-2\"><div class=\"w-8 h-8 rounded bg-purple-500/20 flex items-center justify-center\"><i aria-hidden=\"true\" class=\"fas fa-arrow-left text-purple-400 text-sm\"></i></div><h4 class=\"text-white font-medium\">Remote Forward</h4></div><p class=\"text-gray-400 text-xs\">Forward remote port to local destination</p></div><div class=\"card p-4\"><div class=\"flex items-center gap-3 mb-2\"><div class=\"w-8 h-8 rounded bg-emerald-500/20 flex items-center justify-center\"><i aria-hidden=\"true\" class=\"fas fa-globe text-emerald-400 text-sm\"></i></div><h4 class=\"text-white font-medium\">Dynamic (SOCKS)</h4></div><p class=\"text-gray-400 text-xs\">SOCKS5 proxy through SSH tunnel</p></div></div><!-- Active Tunnels --><div class=\"card\"><div class=\"px-6 py-4 border-b border-dark-600\"><h3 class=\"text-lg font-medium text-white\">Active Tunnels</h3></div><div class=\"divide-y divide-dark-600\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			if len(data.Tunnels) == 0 {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 7, "<div class=\"px-6 py-12 text-center\"><i aria-hidden=\"true\" class=\"fas fa-network-wired text-4xl text-gray-400 mb-4\"></i><p class=\"text-gray-400\">No tunnels configured</p><p class=\"text-gray-500 text-sm mt-1\">Create a tunnel to forward ports through this SSH connection</p></div>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			}
			for _, tunnel := range data.Tunnels {
				...
				if tunnel.Type == "local" {
					templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 9, "<i aria-hidden=\"true\" class=\"fas fa-arrow-right text-blue-400\"></i>")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
				} else if tunnel.Type == "remote" {
					templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 10, "<i aria-hidden=\"true\" class=\"fas fa-arrow-left text-purple-400\"></i>")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
				} else {
					templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 11, "<i aria-hidden=\"true\" class=\"fas fa-globe text-emerald-400\"></i>")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
				}
				...
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 13, "</span> <i aria-hidden=\"true\" class=\"fas fa-long-arrow-alt-right text-gray-500\"></i> <span class=\"text-white font-medium\">")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				...
				if tunnel.Status == "active" {
					templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 27, "<i aria-hidden=\"true\" class=\"fas fa-stop\"></i>")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
				} else {
					templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 28, "<i aria-hidden=\"true\" class=\"fas fa-play\"></i>")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
				}
