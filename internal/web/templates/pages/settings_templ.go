...
func Settings(data SettingsData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 2, "\"><!-- Quick Links --><div class=\"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4\"><a href=\"/admin/notifications/channels\" class=\"card p-4 hover:border-primary-500/50 transition-colors group\"><div class=\"flex items-center gap-3\"><div class=\"w-10 h-10 rounded-lg bg-primary-500/10 flex items-center justify-center\"><i aria-hidden=\"true\" class=\"fas fa-bell text-primary-400 group-hover:scale-110 transition-transform\"></i></div><div><h3 class=\"font-medium text-white\">Notification Channels</h3><p class=\"text-xs text-gray-500\">Configure Slack, Discord, Email...</p></div></div></a> <a href=\"/admin/oauth\" class=\"card p-4 hover:border-primary-500/50 transition-colors group\"><div class=\"flex items-center gap-3\"><div class=\"w-10 h-10 rounded-lg bg-blue-500/10 flex items-center justify-center\"><i aria-hidden=\"true\" class=\"fas fa-key text-blue-400 group-hover:scale-110 transition-transform\"></i></div><div><h3 class=\"font-medium text-white\">OAuth Providers</h3><p class=\"text-xs text-gray-500\">Configure SSO with Google, GitHub...</p></div></div></a> <a href=\"/admin/ldap\" class=\"card p-4 hover:border-primary-500/50 transition-colors group\"><div class=\"flex items-center gap-3\"><div class=\"w-10 h-10 rounded-lg bg-green-500/10 flex items-center justify-center\"><i aria-hidden=\"true\" class=\"fas fa-sitemap text-green-400 group-hover:scale-110 transition-transform\"></i></div><div><h3 class=\"font-medium text-white\">LDAP Providers</h3><p class=\"text-xs text-gray-500\">Configure LDAP/Active Directory...</p></div></div></a> <a href=\"/license\" class=\"card p-4 hover:border-primary-500/50 transition-colors group\"><div class=\"flex items-center gap-3\"><div class=\"w-10 h-10 rounded-lg bg-purple-500/10 flex items-center justify-center\"><i aria-hidden=\"true\" class=\"fas fa-id-card text-purple-400 group-hover:scale-110 transition-transform\"></i></div><div><h3 class=\"font-medium text-white\">License</h3><p class=\"text-xs text-gray-500\">Manage edition and license key</p></div></div></a></div><!-- Account Security --><div class=\"card p-6\"><h2 class=\"text-lg font-medium text-white mb-4\">Account Security</h2><div class=\"flex items-center justify-between\"><div><p class=\"text-sm text-gray-300\">Two-Factor Authentication (2FA)</p><p class=\"text-xs text-gray-500 mt-1\">Add an extra layer of security with TOTP-based 2FA</p></div><a href=\"/settings/totp\" class=\"btn-secondary text-sm\"><i aria-hidden=\"true\" class=\"fas fa-shield-alt mr-2\"></i>Configure 2FA</a></div></div><!-- General --><div class=\"card p-6\"><h2 class=\"text-lg font-medium text-white mb-4\">General</h2><div class=\"space-y-4\"><div><label class=\"block text-sm font-medium text-gray-300 mb-2\">Site Name</label> <input type=\"text\" name=\"site_name\" value=\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 15, "\" class=\"input\"></div></div></div></div><div class=\"flex justify-end\"><button type=\"submit\" class=\"btn-primary\"><i aria-hidden=\"true\" class=\"fas fa-save mr-2\"></i>Save Settings</button></div></form><!-- Sidebar Navigation (per-user, outside the system settings form) -->")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			if len(data.SidebarConfig) > 0 {
				...
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 17, "\"><div class=\"card p-6 mb-6\"><div class=\"flex items-start gap-3 mb-5\"><div class=\"w-10 h-10 rounded-lg bg-primary-500/10 flex items-center justify-center text-primary-400 flex-shrink-0\"><i aria-hidden=\"true\" class=\"fas fa-columns\"></i></div><div><h2 class=\"text-lg font-medium text-white\">Sidebar Navigation</h2><p class=\"text-sm text-gray-400 mt-1\">Choose which items appear in your sidebar. Core navigation items are always visible. Changes are saved automatically.</p></div></div><div class=\"space-y-5\">")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				...
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 26, "</div><!-- Status indicator --><div x-show=\"saved\" x-transition class=\"mt-4 flex items-center gap-2 text-sm text-emerald-400\"><i aria-hidden=\"true\" class=\"fas fa-check-circle\"></i> <span>Sidebar preferences saved</span></div></div></div>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			}
