...
func Create(data CreateData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 2, "\"><div class=\"px-6 py-4 border-b border-dark-700\"><h2 class=\"font-medium text-white\">Backup Configuration</h2></div><div class=\"p-6 space-y-6\"><!-- Backup Type --><div><label class=\"block text-sm font-medium text-gray-300 mb-2\">Backup Type</label><div class=\"grid grid-cols-3 gap-3\"><label class=\"relative\"><input type=\"radio\" name=\"type\" value=\"container\" class=\"peer sr-only\" checked><div class=\"border border-dark-600 rounded-lg p-4 cursor-pointer peer-checked:border-primary-500 peer-checked:bg-primary-500/10 transition-colors\"><div class=\"flex items-center gap-3\"><i aria-hidden=\"true\" class=\"fas fa-cube text-primary-400 text-lg\"></i><div><div class=\"font-medium text-white\">Container</div><div class=\"text-xs text-gray-400\">Backup container data</div></div></div></div></label> <label class=\"relative\"><input type=\"radio\" name=\"type\" value=\"volume\" class=\"peer sr-only\"><div class=\"border border-dark-600 rounded-lg p-4 cursor-pointer peer-checked:border-primary-500 peer-checked:bg-primary-500/10 transition-colors\"><div class=\"flex items-center gap-3\"><i aria-hidden=\"true\" class=\"fas fa-database text-blue-400 text-lg\"></i><div><div class=\"font-medium text-white\">Volume</div><div class=\"text-xs text-gray-400\">Backup volume data</div></div></div></div></label> <label class=\"relative\"><input type=\"radio\" name=\"type\" value=\"stack\" class=\"peer sr-only\"><div class=\"border border-dark-600 rounded-lg p-4 cursor-pointer peer-checked:border-primary-500 peer-checked:bg-primary-500/10 transition-colors\"><div class=\"flex items-center gap-3\"><i aria-hidden=\"true\" class=\"fas fa-layer-group text-green-400 text-lg\"></i><div><div class=\"font-medium text-white\">Stack</div><div class=\"text-xs text-gray-400\">Backup entire stack</div></div></div></div></label></div></div><!-- Target Selection --><input type=\"hidden\" name=\"target_name\" id=\"target_name_field\" value=\"\"><div id=\"target-container\"><label class=\"block text-sm font-medium text-gray-300 mb-2\">Target Container</label> <select name=\"target_id\" required class=\"input\" onchange=\"updateTargetName(this)\"><option value=\"\">Select a container...</option> ")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
