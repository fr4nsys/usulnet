		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			if data.CurrentPath != "" {
				for _, crumb := range pathCrumbs(data.CurrentPath) {
					templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 3, "<i aria-hidden=\"true\" class=\"fas fa-chevron-right text-[10px] text-gray-400\"></i> ")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
					if crumb.IsLast {
			...
			if data.Repo.IsPrivate {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 16, "<span class=\"text-yellow-400\"><i aria-hidden=\"true\" class=\"fas fa-lock mr-1\"></i>Private</span> ")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			} else {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 17, "<span class=\"text-green-400\"><i aria-hidden=\"true\" class=\"fas fa-globe mr-1\"></i>Public</span> ")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			}
			if data.Repo.IsFork {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 18, "<span class=\"text-purple-400\"><i aria-hidden=\"true\" class=\"fas fa-code-branch mr-1\"></i>Fork</span> ")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			}
			if data.Repo.IsArchived {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 19, "<span class=\"text-gray-500\"><i aria-hidden=\"true\" class=\"fas fa-archive mr-1\"></i>Archived</span> ")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			}
			if data.Repo.Stars > 0 {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 20, "<span><i aria-hidden=\"true\" class=\"fas fa-star text-yellow-500 mr-1\"></i>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/templates/pages/gitea/detail.templ`, Line: 237, Col: 116}
				}
			...
			if data.Repo.Forks > 0 {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 22, "<span><i aria-hidden=\"true\" class=\"fas fa-code-branch mr-1\"></i>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/templates/pages/gitea/detail.templ`, Line: 240, Col: 107}
				}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 29, "\" class=\"px-4 py-2 text-sm font-medium text-white border-b-2 border-blue-500 bg-gray-800/50 rounded-t-lg\"><i aria-hidden=\"true\" class=\"fas fa-code mr-2\"></i>Code</a> <a href=\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 30, "\" class=\"px-4 py-2 text-sm font-medium text-gray-400 hover:text-white hover:bg-gray-800/30 rounded-t-lg transition-colors flex items-center gap-2\"><i aria-hidden=\"true\" class=\"fas fa-code-pull-request\"></i>Pull Requests ")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			if data.OpenPRs > 0 {
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 34, "\" class=\"px-4 py-2 text-sm font-medium text-gray-400 hover:text-white hover:bg-gray-800/30 rounded-t-lg transition-colors flex items-center gap-2\"><i aria-hidden=\"true\" class=\"fas fa-circle-exclamation\"></i>Issues ")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 52, "</select> <i aria-hidden=\"true\" class=\"fas fa-code-branch absolute left-2.5 top-1/2 -translate-y-1/2 text-gray-400 text-xs pointer-events-none\"></i> <i aria-hidden=\"true\" class=\"fas fa-chevron-down absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 text-xs pointer-events-none\"></i></div><div class=\"flex items-center gap-3 text-sm text-gray-400\"><span><i aria-hidden=\"true\" class=\"fas fa-code-branch mr-1\"></i>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/templates/pages/gitea/detail.templ`, Line: 335, Col: 104}
			}
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var27))
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 53, "</span> <span><i aria-hidden=\"true\" class=\"fas fa-tag mr-1\"></i>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/templates/pages/gitea/detail.templ`, Line: 338, Col: 92}
			}
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var28))
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 54, "</span></div></div><!-- Branch/Tag Actions --><div class=\"flex items-center gap-2\"><button onclick=\"openCreateBranchModal()\" class=\"btn-ghost text-sm\"><i aria-hidden=\"true\" class=\"fas fa-code-branch mr-1\"></i>New Branch</button> <button onclick=\"openCreateTagModal()\" class=\"btn-ghost text-sm\"><i aria-hidden=\"true\" class=\"fas fa-tag mr-1\"></i>New Tag</button> <button onclick=\"openCompareModal()\" class=\"btn-ghost text-sm\"><i aria-hidden=\"true\" class=\"fas fa-code-compare mr-1\"></i>Compare</button></div></div><!-- Two column layout: Files + Commits --><div class=\"grid grid-cols-1 lg:grid-cols-3 gap-6\"><!-- File Browser (2/3) --><div class=\"lg:col-span-2\"><div class=\"card\"><div class=\"p-3 border-b border-gray-700/50 flex items-center justify-between\"><h3 class=\"text-sm font-medium text-gray-300\"><i aria-hidden=\"true\" class=\"fas fa-folder-open mr-2 text-gray-500\"></i> ")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			if data.CurrentPath == "" {
			...
			if data.CurrentPath != "" {
				...
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 58, "\" class=\"text-sm text-gray-400 hover:text-white transition-colors\"><i aria-hidden=\"true\" class=\"fas fa-level-up-alt mr-1\"></i>Up</a>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			}
			...
			if len(data.Files) > 0 {
				...
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 61, "<div class=\"p-8 text-center text-gray-500\"><i aria-hidden=\"true\" class=\"fas fa-spinner fa-spin mr-2\"></i>Loading files...</div>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 62, "</div></div></div><!-- Recent Commits (1/3) --><div><div class=\"card\"><div class=\"p-3 border-b border-gray-700/50\"><h3 class=\"text-sm font-medium text-gray-300\"><i aria-hidden=\"true\" class=\"fas fa-history mr-2 text-gray-500\"></i>Recent Commits</h3></div>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, f := range files {
			if f.Type == "dir" {
				...
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 70, "\" class=\"flex items-center gap-3 px-4 py-2.5 hover:bg-gray-800/30 transition-colors group\"><i aria-hidden=\"true\" class=\"fas fa-folder text-blue-400\"></i> <span class=\"text-sm text-gray-300 group-hover:text-white\">")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
...
func tier1Modals(data RepoDetailData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 86, "\"><div><label class=\"block text-sm text-gray-400 mb-1\">Branch Name</label> <input type=\"text\" name=\"name\" required placeholder=\"feature/my-branch\" class=\"w-full px-3 py-2 bg-gray-900 border border-gray-600 rounded-lg text-white focus:border-blue-500 focus:ring-1 focus:ring-blue-500\" aria-label=\"Branch Name\"></div><div><label class=\"block text-sm text-gray-400 mb-1\">Source Branch</label> <select name=\"source\" class=\"w-full px-3 py-2 bg-gray-900 border border-gray-600 rounded-lg text-white\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		for _, branch := range data.Branches {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 94, "\"><div><label class=\"block text-sm text-gray-400 mb-1\">Tag Name</label> <input type=\"text\" name=\"name\" required placeholder=\"v1.0.0\" class=\"w-full px-3 py-2 bg-gray-900 border border-gray-600 rounded-lg text-white focus:border-blue-500 focus:ring-1 focus:ring-blue-500\" aria-label=\"Tag Name\"></div><div><label class=\"block text-sm text-gray-400 mb-1\">Target (branch or commit)</label> <input type=\"text\" name=\"target\" placeholder=\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 95, "\" class=\"w-full px-3 py-2 bg-gray-900 border border-gray-600 rounded-lg text-white\" aria-label=\"Target (branch or commit)\"><p class=\"text-xs text-gray-500 mt-1\">Leave empty to use current branch</p></div><div><label class=\"block text-sm text-gray-400 mb-1\">Message (optional, for annotated tag)</label> <textarea name=\"message\" rows=\"2\" placeholder=\"Release notes...\" class=\"w-full px-3 py-2 bg-gray-900 border border-gray-600 rounded-lg text-white resize-none\"></textarea></div><div class=\"flex justify-end gap-3 pt-2\"><button type=\"button\" onclick=\"closeModal('create-tag-modal')\" class=\"btn-ghost\">Cancel</button> <button type=\"submit\" class=\"btn-primary\">Create Tag</button></div></form></div></div><!-- Compare Modal --><div id=\"compare-modal\" class=\"fixed inset-0 bg-black/60 z-50 hidden items-center justify-center\"><div class=\"bg-gray-800 rounded-xl border border-gray-700 p-6 w-full max-w-lg mx-4\"><h3 class=\"text-lg font-semibold text-white mb-4\"><i aria-hidden=\"true\" class=\"fas fa-code-compare mr-2 text-purple-400\"></i>Compare Branches</h3><form id=\"compare-form\" class=\"space-y-4\"><div class=\"grid grid-cols-2 gap-4\"><div><label class=\"block text-sm text-gray-400 mb-1\">Base</label> <select name=\"base\" id=\"compare-base\" class=\"w-full px-3 py-2 bg-gray-900 border border-gray-600 rounded-lg text-white\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		for _, branch := range data.Branches {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 129, "\" class=\"w-full px-3 py-2 bg-gray-900 border border-red-600/50 rounded-lg text-white focus:border-red-500 focus:ring-1 focus:ring-red-500\" aria-label=\"Type repository name to confirm\"></div><div class=\"flex justify-end gap-3 pt-2\"><button type=\"button\" onclick=\"closeModal('delete-repo-modal')\" class=\"btn-ghost\">Cancel</button> <button type=\"submit\" class=\"bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg transition-colors\">Delete Repository</button></div></form></div></div><!-- Commit Detail Modal --><div id=\"commit-detail-modal\" class=\"fixed inset-0 bg-black/60 z-50 hidden items-center justify-center\"><div class=\"bg-gray-800 rounded-xl border border-gray-700 p-6 w-full max-w-2xl mx-4 max-h-[90vh] overflow-y-auto\"><div class=\"flex items-center justify-between mb-4\"><h3 class=\"text-lg font-semibold text-white\"><i aria-hidden=\"true\" class=\"fas fa-code-commit mr-2 text-orange-400\"></i> <span id=\"commit-sha-title\"></span></h3><button onclick=\"closeModal('commit-detail-modal')\" class=\"text-gray-400 hover:text-white\"><i aria-hidden=\"true\" class=\"fas fa-times\"></i></button></div><div id=\"commit-detail-content\"><div class=\"animate-pulse\"><div class=\"h-4 bg-gray-700 rounded w-3/4 mb-2\"></div><div class=\"h-4 bg-gray-700 rounded w-1/2\"></div></div></div></div></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
...
func tier2Modals(data RepoDetailData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/templates/pages/gitea/detail.templ`, Line: 1081, Col: 65}
		}
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var79))
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 135, "\"><div><label class=\"block text-sm text-gray-400 mb-1\">Title</label> <input type=\"text\" name=\"title\" required placeholder=\"What does this PR do?\" class=\"w-full px-3 py-2 bg-gray-900 border border-gray-600 rounded-lg text-white focus:border-blue-500 focus:ring-1 focus:ring-blue-500\" aria-label=\"Title\"></div><div class=\"grid grid-cols-2 gap-4\"><div><label class=\"block text-sm text-gray-400 mb-1\">Head (source)</label> <select name=\"head\" class=\"w-full px-3 py-2 bg-gray-900 border border-gray-600 rounded-lg text-white\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		for _, branch := range data.Branches {
			if branch.Name == data.CurrentBranch && !branch.IsDefault {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/templates/pages/gitea/detail.templ`, Line: 1093, Col: 36}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/templates/pages/gitea/detail.templ`, Line: 1093, Col: 61}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/templates/pages/gitea/detail.templ`, Line: 1095, Col: 36}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/templates/pages/gitea/detail.templ`, Line: 1095, Col: 52}
				}
		...
		for _, branch := range data.Branches {
			if branch.IsDefault {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/templates/pages/gitea/detail.templ`, Line: 1105, Col: 36}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/templates/pages/gitea/detail.templ`, Line: 1105, Col: 61}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/templates/pages/gitea/detail.templ`, Line: 1107, Col: 36}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/templates/pages/gitea/detail.templ`, Line: 1107, Col: 52}
				}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/templates/pages/gitea/detail.templ`, Line: 1133, Col: 65}
		}
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var88))
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 150, "\"><div><label class=\"block text-sm text-gray-400 mb-1\">Title</label> <input type=\"text\" name=\"title\" required placeholder=\"Issue title\" class=\"w-full px-3 py-2 bg-gray-900 border border-gray-600 rounded-lg text-white focus:border-blue-500 focus:ring-1 focus:ring-blue-500\" aria-label=\"Title\"></div><div><label class=\"block text-sm text-gray-400 mb-1\">Description</label> <textarea name=\"body\" rows=\"6\" placeholder=\"Describe the issue...\" class=\"w-full px-3 py-2 bg-gray-900 border border-gray-600 rounded-lg text-white resize-none\"></textarea></div><div class=\"flex justify-end gap-3 pt-2\"><button type=\"button\" onclick=\"closeModal('create-issue-modal')\" class=\"btn-ghost\">Cancel</button> <button type=\"submit\" class=\"btn-primary\">Create Issue</button></div></form></div></div><!-- Collaborators Modal --><div id=\"collaborators-modal\" class=\"fixed inset-0 bg-black/60 z-50 hidden items-center justify-center\"><div class=\"bg-gray-800 rounded-xl border border-gray-700 p-6 w-full max-w-lg mx-4 max-h-[80vh] flex flex-col\"><h3 class=\"text-lg font-semibold text-white mb-4 flex items-center justify-between\"><span><i aria-hidden=\"true\" class=\"fas fa-users mr-2 text-blue-400\"></i>Collaborators</span> <button onclick=\"closeModal('collaborators-modal')\" class=\"text-gray-400 hover:text-white\"><i aria-hidden=\"true\" class=\"fas fa-times\"></i></button></h3><div id=\"collaborators-content\" class=\"flex-1 overflow-y-auto\"><div class=\"text-center py-8 text-gray-400\"><i aria-hidden=\"true\" class=\"fas fa-spinner fa-spin text-2xl mb-2\"></i><p>Loading collaborators...</p></div></div><div class=\"border-t border-gray-700 pt-4 mt-4\"><form id=\"add-collaborator-form\" class=\"flex gap-2\"><input type=\"text\" name=\"username\" placeholder=\"Username\" required class=\"flex-1 px-3 py-2 bg-gray-900 border border-gray-600 rounded-lg text-white text-sm\" aria-label=\"Username\"> <select name=\"permission\" class=\"px-3 py-2 bg-gray-900 border border-gray-600 rounded-lg text-white text-sm\"><option value=\"read\">Read</option> <option value=\"write\" selected>Write</option> <option value=\"admin\">Admin</option></select> <button type=\"submit\" class=\"btn-primary text-sm\">Add</button></form></div></div></div><!-- PR Detail Modal --><div id=\"pr-detail-modal\" class=\"fixed inset-0 bg-black/60 z-50 hidden items-center justify-center\"><div class=\"bg-gray-800 rounded-xl border border-gray-700 p-6 w-full max-w-3xl mx-4 max-h-[85vh] flex flex-col\"><div class=\"flex items-center justify-between mb-4\"><h3 class=\"text-lg font-semibold text-white\"><i aria-hidden=\"true\" class=\"fas fa-code-pull-request mr-2 text-green-400\"></i> <span id=\"pr-detail-title\">Pull Request</span></h3><button onclick=\"closeModal('pr-detail-modal')\" class=\"text-gray-400 hover:text-white\"><i aria-hidden=\"true\" class=\"fas fa-times\"></i></button></div><div id=\"pr-detail-content\" class=\"flex-1 overflow-y-auto\"><div class=\"text-center py-8 text-gray-400\"><i aria-hidden=\"true\" class=\"fas fa-spinner fa-spin text-2xl\"></i></div></div></div></div><!-- Issue Detail Modal --><div id=\"issue-detail-modal\" class=\"fixed inset-0 bg-black/60 z-50 hidden items-center justify-center\"><div class=\"bg-gray-800 rounded-xl border border-gray-700 p-6 w-full max-w-3xl mx-4 max-h-[85vh] flex flex-col\"><div class=\"flex items-center justify-between mb-4\"><h3 class=\"text-lg font-semibold text-white\"><i aria-hidden=\"true\" class=\"fas fa-circle-exclamation mr-2 text-yellow-400\"></i> <span id=\"issue-detail-title\">Issue</span></h3><button onclick=\"closeModal('issue-detail-modal')\" class=\"text-gray-400 hover:text-white\"><i aria-hidden=\"true\" class=\"fas fa-times\"></i></button></div><div id=\"issue-detail-content\" class=\"flex-1 overflow-y-auto\"><div class=\"text-center py-8 text-gray-400\"><i aria-hidden=\"true\" class=\"fas fa-spinner fa-spin text-2xl\"></i></div></div></div></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
