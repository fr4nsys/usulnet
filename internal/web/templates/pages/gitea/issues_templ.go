...
func IssuesList(data IssueListData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 3, "</a> <i aria-hidden=\"true\" class=\"fas fa-chevron-right text-xs\"></i> <span class=\"text-white\">Issues</span></div><!-- Header --><div class=\"flex items-center justify-between\"><div class=\"flex items-center gap-3\"><i aria-hidden=\"true\" class=\"fas fa-circle-exclamation text-2xl text-yellow-400\"></i><div><h1 class=\"text-2xl font-display font-bold text-white\">Issues</h1><p class=\"text-gray-400 text-sm\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 4, "</p></div></div><button onclick=\"openCreateIssueModal()\" class=\"btn-primary\"><i aria-hidden=\"true\" class=\"fas fa-plus mr-2\"></i>New Issue</button></div><!-- Tab Navigation -->")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			if len(data.Issues) == 0 {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 18, "<div class=\"text-center py-12 text-gray-400\"><i aria-hidden=\"true\" class=\"fas fa-circle-check text-4xl mb-4\"></i><p class=\"text-lg\">No issues found</p><p class=\"text-sm mt-2\">Create an issue to track bugs or feature requests</p></div>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			} else {
...
func issueRow(issue IssueItem, repoID string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if issue.Comments > 0 {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 36, "<span><i aria-hidden=\"true\" class=\"fas fa-comment mr-1\"></i>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/templates/pages/gitea/issues.templ`, Line: 140, Col: 99}
			}
...
func createIssueModal(data IssueListData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 40, "\"><div><label class=\"block text-sm text-gray-400 mb-1\">Title</label> <input type=\"text\" name=\"title\" required placeholder=\"Issue title\" class=\"w-full px-3 py-2 bg-gray-900 border border-gray-600 rounded-lg text-white focus:border-blue-500\" aria-label=\"Title\"></div><div><label class=\"block text-sm text-gray-400 mb-1\">Description</label> <textarea name=\"body\" rows=\"6\" placeholder=\"Describe the issue in detail...\" class=\"w-full px-3 py-2 bg-gray-900 border border-gray-600 rounded-lg text-white resize-none\"></textarea></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
