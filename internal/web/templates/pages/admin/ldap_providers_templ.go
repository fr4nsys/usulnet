...
func LDAPProvidersList(data LDAPProvidersData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<div class=\"space-y-6\"><!-- Header --><div class=\"flex items-center justify-between\"><div><h1 class=\"text-2xl font-display font-bold text-white\">LDAP Providers</h1><p class=\"text-gray-400 mt-1\">Manage LDAP/Active Directory authentication sources</p></div><button onclick=\"showNewProviderModal()\" class=\"btn-primary\"><i aria-hidden=\"true\" class=\"fas fa-plus mr-2\"></i>Add Provider</button></div><!-- Stats Cards --><div class=\"grid grid-cols-3 gap-4\"><div class=\"card p-4\"><div class=\"text-2xl font-bold text-white\">")
			if templ_7745c5c3_Err != nil {
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 4, "</div><div class=\"text-sm text-gray-400\">Disabled</div></div></div><!-- Providers Table --><div class=\"card\"><div class=\"overflow-x-auto\"><table class=\"table\"><thead><tr><th scope=\"col\">Provider</th><th scope=\"col\">Host</th><th scope=\"col\">Base DN</th><th scope=\"col\">Security</th><th scope=\"col\">Default Role</th><th scope=\"col\">Status</th><th scope=\"col\">Actions</th></tr></thead> <tbody>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			if len(data.Providers) == 0 {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 5, "<tr><td colspan=\"7\" class=\"text-center text-gray-500 py-8\"><i aria-hidden=\"true\" class=\"fas fa-sitemap text-4xl mb-3 block\"></i> No LDAP providers configured yet</td></tr>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			}
			for _, provider := range data.Providers {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 6, "<tr><td><div class=\"flex items-center gap-3\"><div class=\"w-8 h-8 rounded-lg bg-blue-500/20 flex items-center justify-center\"><i aria-hidden=\"true\" class=\"fas fa-sitemap text-blue-400\"></i></div><div><div class=\"font-medium text-white\">")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 31, "</tbody></table></div></div><!-- Provider Info --><div class=\"card p-6\"><h3 class=\"text-lg font-semibold text-white mb-4\">About LDAP Authentication</h3><div class=\"grid grid-cols-1 md:grid-cols-3 gap-4\"><div class=\"flex items-start gap-3 p-3 bg-dark-700 rounded-lg\"><div class=\"w-10 h-10 rounded-lg bg-blue-500/20 flex items-center justify-center shrink-0\"><i aria-hidden=\"true\" class=\"fas fa-sitemap text-blue-400\"></i></div><div><div class=\"font-medium text-white\">LDAP/OpenLDAP</div><div class=\"text-xs text-gray-500\">Standard LDAP protocol for directory services</div></div></div><div class=\"flex items-start gap-3 p-3 bg-dark-700 rounded-lg\"><div class=\"w-10 h-10 rounded-lg bg-blue-600/20 flex items-center justify-center shrink-0\"><i aria-hidden=\"true\" class=\"fab fa-microsoft text-blue-500\"></i></div><div><div class=\"font-medium text-white\">Active Directory</div><div class=\"text-xs text-gray-500\">Microsoft Active Directory support</div></div></div><div class=\"flex items-start gap-3 p-3 bg-dark-700 rounded-lg\"><div class=\"w-10 h-10 rounded-lg bg-green-500/20 flex items-center justify-center shrink-0\"><i aria-hidden=\"true\" class=\"fas fa-users text-green-400\"></i></div><div><div class=\"font-medium text-white\">Group Mapping</div><div class=\"text-xs text-gray-500\">Map LDAP groups to usulnet roles</div></div></div></div></div></div><!-- New Provider Modal --> <div id=\"newProviderModal\" class=\"fixed inset-0 bg-black/50 hidden items-center justify-center z-50\"><div class=\"bg-dark-800 rounded-xl shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto\"><div class=\"p-6 border-b border-dark-700\"><h2 class=\"text-xl font-display font-bold text-white\">Add LDAP Provider</h2></div><form action=\"/admin/ldap\" method=\"POST\" class=\"p-6 space-y-4\"><input type=\"hidden\" name=\"csrf_token\" value=\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
...
func LDAPProviderEdit(data LDAPProviderEditData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var22 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 61, "><summary class=\"p-4 cursor-pointer text-gray-300 hover:text-white\"><i aria-hidden=\"true\" class=\"fas fa-users-cog mr-2\"></i>Group Role Mapping</summary><div class=\"p-4 pt-0 space-y-4\"><div><label class=\"block text-sm font-medium text-gray-300 mb-2\">Group Filter</label> <input type=\"text\" name=\"group_filter\" value=\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 68, "\" hx-swap=\"none\" class=\"btn-secondary\"><i aria-hidden=\"true\" class=\"fas fa-plug mr-2\"></i>Test</button></div></div><!-- Metadata --><div class=\"card p-4 text-sm text-gray-500\"><div class=\"flex justify-between\"><span>Created: ")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
