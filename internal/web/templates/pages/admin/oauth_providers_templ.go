...
func OAuthProvidersList(data OAuthProvidersData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 4, "</div><div class=\"text-sm text-gray-400\">Disabled</div></div></div><!-- Providers Table --><div class=\"card\"><div class=\"overflow-x-auto\"><table class=\"table\"><thead><tr><th scope=\"col\">Provider</th><th scope=\"col\">Type</th><th scope=\"col\">Client ID</th><th scope=\"col\">Default Role</th><th scope=\"col\">Auto Provision</th><th scope=\"col\">Status</th><th scope=\"col\">Actions</th></tr></thead> <tbody>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			if len(data.Providers) == 0 {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 5, "<tr><td colspan=\"7\" class=\"text-center text-gray-500 py-8\"><i aria-hidden=\"true\" class=\"fas fa-key text-4xl mb-3 block\"></i> No OAuth providers configured yet</td></tr>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			}
			for _, provider := range data.Providers {
				...
				if provider.AutoProvision {
					templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 20, "<span class=\"text-green-400\"><i aria-hidden=\"true\" class=\"fas fa-check\"></i></span>")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
				} else {
					templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 21, "<span class=\"text-gray-500\"><i aria-hidden=\"true\" class=\"fas fa-times\"></i></span>")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
				}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 34, "</tbody></table></div></div><!-- Provider Info --><div class=\"card p-6\"><h3 class=\"text-lg font-semibold text-white mb-4\">Supported Providers</h3><div class=\"grid grid-cols-2 md:grid-cols-5 gap-4\"><div class=\"flex items-center gap-3 p-3 bg-dark-700 rounded-lg\"><div class=\"w-10 h-10 rounded-lg bg-gray-500/20 flex items-center justify-center\"><i aria-hidden=\"true\" class=\"fas fa-globe text-gray-400\"></i></div><div><div class=\"font-medium text-white\">Generic</div><div class=\"text-xs text-gray-500\">OAuth2</div></div></div><div class=\"flex items-center gap-3 p-3 bg-dark-700 rounded-lg\"><div class=\"w-10 h-10 rounded-lg bg-blue-500/20 flex items-center justify-center\"><i aria-hidden=\"true\" class=\"fas fa-id-card text-blue-400\"></i></div><div><div class=\"font-medium text-white\">OIDC</div><div class=\"text-xs text-gray-500\">OpenID Connect</div></div></div><div class=\"flex items-center gap-3 p-3 bg-dark-700 rounded-lg\"><div class=\"w-10 h-10 rounded-lg bg-[#24292e] flex items-center justify-center\"><i aria-hidden=\"true\" class=\"fab fa-github text-white\"></i></div><div><div class=\"font-medium text-white\">GitHub</div><div class=\"text-xs text-gray-500\">OAuth App</div></div></div><div class=\"flex items-center gap-3 p-3 bg-dark-700 rounded-lg\"><div class=\"w-10 h-10 rounded-lg bg-red-500/20 flex items-center justify-center\"><i aria-hidden=\"true\" class=\"fab fa-google text-red-400\"></i></div><div><div class=\"font-medium text-white\">Google</div><div class=\"text-xs text-gray-500\">OIDC</div></div></div><div class=\"flex items-center gap-3 p-3 bg-dark-700 rounded-lg\"><div class=\"w-10 h-10 rounded-lg bg-blue-600/20 flex items-center justify-center\"><i aria-hidden=\"true\" class=\"fab fa-microsoft text-blue-500\"></i></div><div><div class=\"font-medium text-white\">Microsoft</div><div class=\"text-xs text-gray-500\">Azure AD</div></div></div></div></div></div><!-- New Provider Modal --> <div id=\"newProviderModal\" class=\"fixed inset-0 bg-black/50 hidden items-center justify-center z-50\"><div class=\"bg-dark-800 rounded-xl shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto\"><div class=\"p-6 border-b border-dark-700\"><h2 class=\"text-xl font-display font-bold text-white\">Add OAuth Provider</h2></div><form action=\"/admin/oauth\" method=\"POST\" class=\"p-6 space-y-4\"><input type=\"hidden\" name=\"csrf_token\" value=\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 35, "\"><div class=\"grid grid-cols-2 gap-4\"><div><label class=\"block text-sm font-medium text-gray-300 mb-2\">Provider Name</label> <input type=\"text\" name=\"name\" required class=\"input\" placeholder=\"e.g. GitHub SSO\" aria-label=\"e.g. GitHub SSO\"></div><div><label class=\"block text-sm font-medium text-gray-300 mb-2\">Provider Type</label> <select name=\"provider\" id=\"providerType\" required class=\"input\" onchange=\"updateProviderDefaults()\"><option value=\"\">Select type...</option> <option value=\"generic\">Generic OAuth2</option> <option value=\"oidc\">OpenID Connect</option> <option value=\"github\">GitHub</option> <option value=\"google\">Google</option> <option value=\"microsoft\">Microsoft</option></select></div></div><div class=\"grid grid-cols-2 gap-4\"><div><label class=\"block text-sm font-medium text-gray-300 mb-2\">Client ID</label> <input type=\"text\" name=\"client_id\" required class=\"input\" placeholder=\"Your OAuth client ID\" aria-label=\"Your OAuth client ID\"></div><div><label class=\"block text-sm font-medium text-gray-300 mb-2\">Client Secret</label> <input type=\"password\" name=\"client_secret\" required class=\"input\" placeholder=\"Your OAuth client secret\" aria-label=\"Your OAuth client secret\"></div></div><div id=\"urlFields\" class=\"space-y-4\"><div><label class=\"block text-sm font-medium text-gray-300 mb-2\">Authorization URL</label> <input type=\"url\" name=\"auth_url\" id=\"authUrl\" class=\"input\" placeholder=\"https://example.com/oauth/authorize\" aria-label=\"https://example.com/oauth/authorize\"></div><div><label class=\"block text-sm font-medium text-gray-300 mb-2\">Token URL</label> <input type=\"url\" name=\"token_url\" id=\"tokenUrl\" class=\"input\" placeholder=\"https://example.com/oauth/token\" aria-label=\"https://example.com/oauth/token\"></div><div><label class=\"block text-sm font-medium text-gray-300 mb-2\">User Info URL</label> <input type=\"url\" name=\"user_info_url\" id=\"userInfoUrl\" class=\"input\" placeholder=\"https://example.com/oauth/userinfo\" aria-label=\"https://example.com/oauth/userinfo\"></div></div><div><label class=\"block text-sm font-medium text-gray-300 mb-2\">Scopes</label> <input type=\"text\" name=\"scopes\" id=\"scopesInput\" class=\"input\" placeholder=\"openid profile email\" aria-label=\"openid profile email\"><p class=\"text-xs text-gray-500 mt-1\">Space-separated list of scopes</p></div><div><label class=\"block text-sm font-medium text-gray-300 mb-2\">Redirect URL</label> <input type=\"url\" name=\"redirect_url\" class=\"input\" placeholder=\"Leave empty for auto-generated\" aria-label=\"Leave empty for auto-generated\"><p class=\"text-xs text-gray-500 mt-1\">Usually: https://your-domain/auth/oauth/callback</p></div><div class=\"grid grid-cols-2 gap-4\"><div><label class=\"block text-sm font-medium text-gray-300 mb-2\">Default Role</label> <select name=\"default_role\" class=\"input\"><option value=\"viewer\">Viewer</option> <option value=\"operator\">Operator</option> <option value=\"admin\">Admin</option></select></div><div class=\"flex items-center gap-4 pt-7\"><label class=\"flex items-center gap-2 cursor-pointer\"><input type=\"checkbox\" name=\"auto_provision\" checked class=\"w-4 h-4 rounded border-gray-600 bg-dark-700 text-primary-500 focus:ring-primary-500\"> <span class=\"text-sm text-gray-300\">Auto-provision users</span></label> <label class=\"flex items-center gap-2 cursor-pointer\"><input type=\"checkbox\" name=\"is_enabled\" class=\"w-4 h-4 rounded border-gray-600 bg-dark-700 text-primary-500 focus:ring-primary-500\"> <span class=\"text-sm text-gray-300\">Enable provider</span></label></div></div><!-- Group Mapping --><details class=\"bg-dark-700 rounded-lg\"><summary class=\"p-4 cursor-pointer text-gray-300 hover:text-white\"><i aria-hidden=\"true\" class=\"fas fa-users-cog mr-2\"></i>Group Role Mapping (optional)</summary><div class=\"p-4 pt-0 space-y-4\"><div><label class=\"block text-sm font-medium text-gray-300 mb-2\">Admin Group</label> <input type=\"text\" name=\"admin_group\" class=\"input\" placeholder=\"Group name for admin role\" aria-label=\"Group name for admin role\"></div><div><label class=\"block text-sm font-medium text-gray-300 mb-2\">Operator Group</label> <input type=\"text\" name=\"operator_group\" class=\"input\" placeholder=\"Group name for operator role\" aria-label=\"Group name for operator role\"></div></div></details><!-- Claim Mapping --><details class=\"bg-dark-700 rounded-lg\"><summary class=\"p-4 cursor-pointer text-gray-300 hover:text-white\"><i aria-hidden=\"true\" class=\"fas fa-tags mr-2\"></i>Claim Mapping (advanced)</summary><div class=\"p-4 pt-0 grid grid-cols-2 gap-4\"><div><label class=\"block text-sm font-medium text-gray-300 mb-2\">User ID Claim</label> <input type=\"text\" name=\"user_id_claim\" class=\"input\" value=\"sub\"></div><div><label class=\"block text-sm font-medium text-gray-300 mb-2\">Username Claim</label> <input type=\"text\" name=\"username_claim\" class=\"input\" value=\"preferred_username\"></div><div><label class=\"block text-sm font-medium text-gray-300 mb-2\">Email Claim</label> <input type=\"text\" name=\"email_claim\" class=\"input\" value=\"email\"></div><div><label class=\"block text-sm font-medium text-gray-300 mb-2\">Groups Claim</label> <input type=\"text\" name=\"groups_claim\" class=\"input\" value=\"groups\"></div></div></details><div class=\"flex justify-end gap-3 pt-4\"><button type=\"button\" onclick=\"hideNewProviderModal()\" class=\"btn-secondary\">Cancel</button> <button type=\"submit\" class=\"btn-primary\">Create Provider</button></div></form></div></div><script>\n\t\t\tfunction showNewProviderModal() {\n\t\t\t\tdocument.getElementById('newProviderModal').classList.remove('hidden');\n\t\t\t\tdocument.getElementById('newProviderModal').classList.add('flex');\n\t\t\t}\n\n\t\t\tfunction hideNewProviderModal() {\n\t\t\t\tdocument.getElementById('newProviderModal').classList.add('hidden');\n\t\t\t\tdocument.getElementById('newProviderModal').classList.remove('flex');\n\t\t\t}\n\n\t\t\tfunction editProvider(id) {\n\t\t\t\t// Redirect to edit page or open edit modal\n\t\t\t\twindow.location.href = '/admin/oauth/' + id;\n\t\t\t}\n\n\t\t\tfunction updateProviderDefaults() {\n\t\t\t\tconst provider = document.getElementById('providerType').value;\n\t\t\t\tconst authUrl = document.getElementById('authUrl');\n\t\t\t\tconst tokenUrl = document.getElementById('tokenUrl');\n\t\t\t\tconst userInfoUrl = document.getElementById('userInfoUrl');\n\t\t\t\tconst scopes = document.getElementById('scopesInput');\n\n\t\t\t\tconst defaults = {\n\t\t\t\t\t'github': {\n\t\t\t\t\t\tauth: 'https://github.com/login/oauth/authorize',\n\t\t\t\t\t\ttoken: 'https://github.com/login/oauth/access_token',\n\t\t\t\t\t\tuserInfo: 'https://api.github.com/user',\n\t\t\t\t\t\tscopes: 'read:user user:email'\n\t\t\t\t\t},\n\t\t\t\t\t'google': {\n\t\t\t\t\t\tauth: 'https://accounts.google.com/o/oauth2/v2/auth',\n\t\t\t\t\t\ttoken: 'https://oauth2.googleapis.com/token',\n\t\t\t\t\t\tuserInfo: 'https://openidconnect.googleapis.com/v1/userinfo',\n\t\t\t\t\t\tscopes: 'openid profile email'\n\t\t\t\t\t},\n\t\t\t\t\t'microsoft': {\n\t\t\t\t\t\tauth: 'https://login.microsoftonline.com/common/oauth2/v2.0/authorize',\n\t\t\t\t\t\ttoken: 'https://login.microsoftonline.com/common/oauth2/v2.0/token',\n\t\t\t\t\t\tuserInfo: 'https://graph.microsoft.com/oidc/userinfo',\n\t\t\t\t\t\tscopes: 'openid profile email'\n\t\t\t\t\t},\n\t\t\t\t\t'oidc': {\n\t\t\t\t\t\tauth: '',\n\t\t\t\t\t\ttoken: '',\n\t\t\t\t\t\tuserInfo: '',\n\t\t\t\t\t\tscopes: 'openid profile email'\n\t\t\t\t\t}\n\t\t\t\t};\n\n\t\t\t\tif (defaults[provider]) {\n\t\t\t\t\tauthUrl.value = defaults[provider].auth;\n\t\t\t\t\ttokenUrl.value = defaults[provider].token;\n\t\t\t\t\tuserInfoUrl.value = defaults[provider].userInfo;\n\t\t\t\t\tscopes.value = defaults[provider].scopes;\n\t\t\t\t} else {\n\t\t\t\t\tauthUrl.value = '';\n\t\t\t\t\ttokenUrl.value = '';\n\t\t\t\t\tuserInfoUrl.value = '';\n\t\t\t\t\tscopes.value = '';\n\t\t\t\t}\n\t\t\t}\n\n\t\t\t// Close modal on escape key\n\t\t\tdocument.addEventListener('keydown', function(e) {\n\t\t\t\tif (e.key === 'Escape') {\n\t\t\t\t\thideNewProviderModal();\n\t\t\t\t}\n\t\t\t});\n\n\t\t\t// Close modal on background click\n\t\t\tdocument.getElementById('newProviderModal').addEventListener('click', function(e) {\n\t\t\t\tif (e.target === this) {\n\t\t\t\t\thideNewProviderModal();\n\t\t\t\t}\n\t\t\t});\n\t\t</script>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			return nil
...
func OAuthProviderEdit(data OAuthProviderEditData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var26 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 36, "<div class=\"max-w-2xl mx-auto space-y-6\"><div class=\"flex items-center gap-4\"><a href=\"/admin/oauth\" class=\"p-2 text-gray-400 hover:text-white hover:bg-dark-700 rounded-lg\"><i aria-hidden=\"true\" class=\"fas fa-arrow-left\"></i></a><div><h1 class=\"text-2xl font-display font-bold text-white\">Edit OAuth Provider</h1><p class=\"text-gray-400 text-sm\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 54, "\" required class=\"input\"></div><div><label class=\"block text-sm font-medium text-gray-300 mb-2\">Client Secret</label> <input type=\"password\" name=\"client_secret\" class=\"input\" placeholder=\"Leave blank to keep current\" aria-label=\"Leave blank to keep current\"></div></div><div><label class=\"block text-sm font-medium text-gray-300 mb-2\">Authorization URL</label> <input type=\"url\" name=\"auth_url\" value=\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 71, "><summary class=\"p-4 cursor-pointer text-gray-300 hover:text-white\"><i aria-hidden=\"true\" class=\"fas fa-users-cog mr-2\"></i>Group Role Mapping</summary><div class=\"p-4 pt-0 space-y-4\"><div><label class=\"block text-sm font-medium text-gray-300 mb-2\">Admin Group</label> <input type=\"text\" name=\"admin_group\" value=\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 73, "\" class=\"input\"></div></div></details><!-- Claim Mapping --><details class=\"bg-dark-700 rounded-lg\"><summary class=\"p-4 cursor-pointer text-gray-300 hover:text-white\"><i aria-hidden=\"true\" class=\"fas fa-tags mr-2\"></i>Claim Mapping</summary><div class=\"p-4 pt-0 grid grid-cols-2 gap-4\"><div><label class=\"block text-sm font-medium text-gray-300 mb-2\">User ID Claim</label> <input type=\"text\" name=\"user_id_claim\" value=\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
