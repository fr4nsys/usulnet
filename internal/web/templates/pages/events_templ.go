...
func Events(data EventsData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<div class=\"space-y-6\"><!-- Header --><div class=\"flex items-center justify-between\"><div><h1 class=\"text-2xl font-display font-bold text-white\">Events</h1><p class=\"text-gray-400 mt-1\">Real-time Docker events stream</p></div><div class=\"flex items-center gap-2\"><select id=\"event-filter\" class=\"input w-40\" onchange=\"filterEvents(this.value)\"><option value=\"\">All Events</option> <option value=\"container\">Containers</option> <option value=\"image\">Images</option> <option value=\"volume\">Volumes</option> <option value=\"network\">Networks</option></select></div></div><!-- Connection Status --><div id=\"ws-status\" class=\"hidden bg-yellow-500/10 border border-yellow-500/20 rounded-lg p-3 text-yellow-400 text-sm\"><i aria-hidden=\"true\" class=\"fas fa-plug mr-2\"></i>Connecting to event stream...</div><!-- Events List --><div class=\"card\"><div id=\"events-list\" class=\"divide-y divide-dark-700 max-h-[70vh] overflow-y-auto\">")
			if templ_7745c5c3_Err != nil {
			...
			if len(data.Events) == 0 {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 18, "<i aria-hidden=\"true\" class=\"fas fa-stream text-3xl mb-3\"></i><p>Waiting for events... Events will appear here in real-time.</p>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			}
