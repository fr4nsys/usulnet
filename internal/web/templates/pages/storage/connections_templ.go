...
func ConnectionsList(data StorageListData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<div class=\"space-y-6\"><!-- Header --><div class=\"flex items-center justify-between\"><div><h1 class=\"text-2xl font-display font-bold text-white\">Object Storage</h1><p class=\"text-gray-400 mt-1\">S3-compatible storage connections (MinIO, AWS, etc.)</p></div><button onclick=\"document.getElementById('create-modal').classList.remove('hidden')\" class=\"btn-primary\"><i class=\"fas fa-plus mr-2\"></i>Add Connection</button></div>")
			if templ_7745c5c3_Err != nil {
...
func createConnectionModal(csrfToken string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 29, "<div id=\"create-modal\" class=\"hidden fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm\"><div class=\"card w-full max-w-lg mx-4 p-6\"><div class=\"flex items-center justify-between mb-6\"><h2 class=\"text-lg font-display font-bold text-white\">New Storage Connection</h2><button onclick=\"document.getElementById('create-modal').classList.add('hidden')\" class=\"text-gray-400 hover:text-white\"><i class=\"fas fa-times\"></i></button></div><form method=\"POST\" action=\"/storage/connections\" class=\"space-y-4\"><input type=\"hidden\" name=\"csrf_token\" value=\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 30, "\"><div><label class=\"label\">Connection Name</label> <input type=\"text\" name=\"name\" required placeholder=\"My MinIO\" class=\"input\"></div><div class=\"grid grid-cols-2 gap-4\"><div><label class=\"label\">Endpoint</label> <input type=\"text\" name=\"endpoint\" required placeholder=\"minio:9000\" class=\"input\"></div><div><label class=\"label\">Region</label> <input type=\"text\" name=\"region\" value=\"us-east-1\" class=\"input\"></div></div><div class=\"grid grid-cols-2 gap-4\"><div><label class=\"label\">Access Key</label> <input type=\"text\" name=\"access_key\" required class=\"input\" autocomplete=\"off\"></div><div><label class=\"label\">Secret Key</label> <input type=\"password\" name=\"secret_key\" required class=\"input\" autocomplete=\"off\"></div></div><div class=\"flex items-center gap-6\"><label class=\"flex items-center gap-2 text-sm text-gray-300 cursor-pointer\"><input type=\"checkbox\" name=\"use_path_style\" checked class=\"form-checkbox rounded bg-dark-700 border-dark-500 text-primary-500\"> Path Style</label> <label class=\"flex items-center gap-2 text-sm text-gray-300 cursor-pointer\"><input type=\"checkbox\" name=\"use_ssl\" class=\"form-checkbox rounded bg-dark-700 border-dark-500 text-primary-500\"> Use SSL</label> <label class=\"flex items-center gap-2 text-sm text-gray-300 cursor-pointer\"><input type=\"checkbox\" name=\"is_default\" class=\"form-checkbox rounded bg-dark-700 border-dark-500 text-primary-500\"> Default</label></div><div class=\"flex items-center gap-3 pt-2\"><button type=\"submit\" class=\"btn-primary flex-1\"><i class=\"fas fa-plus mr-2\"></i>Create Connection</button> <button type=\"button\" onclick=\"document.getElementById('create-modal').classList.add('hidden')\" class=\"btn-secondary\">Cancel</button></div></form></div></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
