...
func Nvim(data NvimData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 5, "<!-- File info --><div class=\"flex items-center gap-2 min-w-0\"><i aria-hidden=\"true\" class=\"fas fa-terminal text-green-400\"></i> ")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			if data.FilePath != "" {
			...
			if data.Ref != "" {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 9, "<span class=\"text-xs px-1.5 py-0.5 rounded bg-gray-700 text-gray-400 whitespace-nowrap\"><i aria-hidden=\"true\" class=\"fas fa-code-branch mr-1\"></i>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/templates/pages/editor/nvim.templ`, Line: 53, Col: 76}
				}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 11, "<span class=\"text-xs px-1.5 py-0.5 rounded bg-green-500/10 text-green-400\">nvim</span></div></div><div class=\"flex items-center gap-2\"><!-- Connection status --><span id=\"nvim-status\" class=\"text-xs text-gray-500\"><i aria-hidden=\"true\" class=\"fas fa-circle text-yellow-400 text-[6px] mr-1\"></i>Connecting...</span><!-- Open in Monaco -->")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			if data.RepoID != "" {
				...
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 13, "\" class=\"btn-ghost text-sm\" title=\"Open in Monaco\"><i aria-hidden=\"true\" class=\"fas fa-edit mr-1\"></i>Monaco</a>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			} else {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 14, "<a href=\"/editor/monaco\" class=\"btn-ghost text-sm\" title=\"Open Monaco\"><i aria-hidden=\"true\" class=\"fas fa-edit mr-1\"></i>Monaco</a>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 15, "<!-- Fullscreen --><button onclick=\"toggleFullscreen()\" class=\"btn-ghost text-sm\" title=\"Fullscreen (F11)\"><i aria-hidden=\"true\" class=\"fas fa-expand\"></i></button><!-- Reconnect --><button onclick=\"reconnectNvim()\" class=\"btn-ghost text-sm\" title=\"Reconnect\"><i aria-hidden=\"true\" class=\"fas fa-redo\"></i></button></div></div><!-- Terminal Container --><div id=\"nvim-terminal\" class=\"flex-1 bg-[#0d1117] overflow-hidden\" data-repo-id=\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
