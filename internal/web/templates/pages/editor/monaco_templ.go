	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			if data.RepoID != "" {
				...
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 3, "\" class=\"text-gray-400 hover:text-white transition-colors\" title=\"Back to repo\"><i aria-hidden=\"true\" class=\"fas fa-arrow-left\"></i></a>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			} else {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 4, "<a href=\"/editor\" class=\"text-gray-400 hover:text-white transition-colors\" title=\"Back to editor\"><i aria-hidden=\"true\" class=\"fas fa-arrow-left\"></i></a>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 5, "<!-- File info --><div class=\"flex items-center gap-2 min-w-0\"><i aria-hidden=\"true\" class=\"fas fa-file-code text-blue-400\"></i> <span class=\"text-sm text-white font-medium truncate\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			if data.Ref != "" {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 7, "<span class=\"text-xs px-1.5 py-0.5 rounded bg-gray-700 text-gray-400 whitespace-nowrap\"><i aria-hidden=\"true\" class=\"fas fa-code-branch mr-1\"></i>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/templates/pages/editor/monaco.templ`, Line: 54, Col: 76}
				}
			...
			if data.RepoName != "" {
				...
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 11, "<span class=\"text-xs px-1.5 py-0.5 rounded bg-yellow-500/10 text-yellow-400\"><i aria-hidden=\"true\" class=\"fas fa-file-alt mr-1\"></i>snippet</span>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			} else {
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 13, "</div></div><div class=\"flex items-center gap-2\"><!-- Save indicator --><span id=\"save-status\" class=\"text-xs text-gray-500 hidden\"><i aria-hidden=\"true\" class=\"fas fa-check text-green-400 mr-1\"></i>Saved</span> <span id=\"save-dirty\" class=\"text-xs text-yellow-400 hidden\"><i aria-hidden=\"true\" class=\"fas fa-circle text-[6px] mr-1\"></i>Modified</span><!-- Language indicator --><span class=\"text-xs px-2 py-1 rounded bg-dark-700 text-gray-400\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			if data.RepoID != "" && !data.ReadOnly {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 15, "<button id=\"btn-save\" onclick=\"saveFile()\" class=\"btn-primary text-sm\" title=\"Ctrl+S\"><i aria-hidden=\"true\" class=\"fas fa-save mr-1\"></i>Save & Commit</button>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			}
			...
			if data.SnippetID != "" {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 17, "<button id=\"btn-save-snippet\" onclick=\"saveSnippet()\" class=\"btn-primary text-sm\" title=\"Ctrl+S\"><i aria-hidden=\"true\" class=\"fas fa-save mr-1\"></i>Save</button>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			}
			...
			if data.RepoID != "" {
				...
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 20, "\" class=\"btn-ghost text-sm\" title=\"Open in Neovim\"><i aria-hidden=\"true\" class=\"fas fa-terminal mr-1\"></i>nvim</a>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			} else {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 21, "<a href=\"/editor/nvim\" class=\"btn-ghost text-sm\" title=\"Open Neovim\"><i aria-hidden=\"true\" class=\"fas fa-terminal mr-1\"></i>nvim</a>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			}
