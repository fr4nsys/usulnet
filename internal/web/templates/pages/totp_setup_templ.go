...
func TOTPSetup(data TOTPSetupData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			if data.Success != "" {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 4, "<div class=\"mb-6 p-4 rounded-lg bg-green-500/10 border border-green-500/20 text-green-400 text-sm flex items-start gap-3\"><i aria-hidden=\"true\" class=\"fas fa-check-circle mt-0.5\"></i> <span>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			...
			if data.Enabled {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 6, "<!-- 2FA is enabled --> <div class=\"card p-6\"><div class=\"flex items-center gap-4 mb-6\"><div class=\"flex items-center justify-center w-12 h-12 rounded-xl bg-green-500/10\"><i aria-hidden=\"true\" class=\"fas fa-shield-alt text-green-400 text-xl\"></i></div><div><h2 class=\"text-lg font-semibold text-white\">2FA Enabled</h2><p class=\"text-sm text-gray-400\">Your account is protected with two-factor authentication</p></div></div><div class=\"p-4 rounded-lg bg-yellow-500/5 border border-yellow-500/20 mb-6\"><p class=\"text-sm text-yellow-400\"><i aria-hidden=\"true\" class=\"fas fa-exclamation-triangle mr-2\"></i> Disabling 2FA will reduce your account security. You'll need to enter your current TOTP code to confirm.</p></div><form method=\"POST\" action=\"/settings/totp/disable\" class=\"flex items-end gap-4\" x-data=\"{ confirm: false }\"><input type=\"hidden\" name=\"csrf_token\" value=\"")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
