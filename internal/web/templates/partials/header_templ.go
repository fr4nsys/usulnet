...
func Header(user *types.UserData, notificationsCount int, hosts []types.HostSelectorItem, activeHostID string, activeHostName string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 16, "<!-- Search --><div class=\"flex-1 max-w-xl\"><div class=\"relative\"><input type=\"search\" name=\"q\" placeholder=\"Search containers, images, networks...\" class=\"w-full pl-10 pr-4 py-2 bg-dark-800 border border-dark-600 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-primary-500/50 focus:border-primary-500 transition-colors\" hx-get=\"/partials/search\" hx-trigger=\"keyup changed delay:300ms\" hx-target=\"#search-results\"> <i class=\"fas fa-search absolute left-3 top-1/2 -translate-y-1/2 text-gray-500\"></i> <kbd class=\"hidden md:inline-flex absolute right-3 top-1/2 -translate-y-1/2 px-2 py-0.5 text-xs bg-dark-700 text-gray-400 rounded border border-dark-600\">⌘K</kbd></div><div id=\"search-results\"></div></div></div><!-- Right Section --><div class=\"flex items-center gap-4 ml-4\"><!-- Theme Toggle --><button onclick=\"usulnet.toggleTheme()\" class=\"p-2 text-gray-400 hover:text-white transition-colors\" title=\"Toggle theme\"><i class=\"fas fa-moon\"></i></button><!-- Notifications --><div x-data=\"{ open: false }\" class=\"relative\"><button @click=\"open = !open\" class=\"relative p-2 text-gray-400 hover:text-white transition-colors\"><i class=\"fas fa-bell\"></i> ")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if notificationsCount > 0 {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/templates/partials/header.templ`, Line: 111, Col: 41}
			}
